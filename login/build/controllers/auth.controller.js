    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    token = jsonwebtoken_1.default.sign({ userId: user._id }, process.env.secret, {
...
function signIn(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var user, passwordIsValid, token, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 1:
                    ...
                    passwordIsValid = bcrypt_1.default.compareSync(req.body.password, user.password);
                    if (!passwordIsValid) {
                ...
                case 2:
                    err_2 = _a.sent();
                    res.status(500).send({ message: err_2 });
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
